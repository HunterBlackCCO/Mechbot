...
void EmptyLinkFunctionForGeneratedCodeMechbot_init() {}
	...
	FORCENOINLINE UPackage* Z_Construct_UPackage__Script_Mechbot()
	{
		if (!Z_Registration_Info_UPackage__Script_Mechbot.OuterSingleton)
		{
			static UObject* (*const SingletonFuncArray[])() = {
				(UObject* (*)())Z_Construct_UDelegateFunction_Mechbot_OnCreated__DelegateSignature,
				...
				(UObject* (*)())Z_Construct_UDelegateFunction_Mechbot_OnLoad__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_Mechbot_OnRevive__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_Mechbot_OnSave__DelegateSignature,
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferPackage_UPackage__Script_Mechbot(Z_Construct_UPackage__Script_Mechbot, TEXT("/Script/Mechbot"), Z_Registration_Info_UPackage__Script_Mechbot, CONSTRUCT_RELOAD_VERSION_INFO(FPackageReloadVersionInfo, 0xE9232F7E, 0x27B9DBC9));
